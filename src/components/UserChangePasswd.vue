<template>
    <div>
        <el-dialog title="修改密码" :visible.sync="dialogVisible" width="30%">
            <el-form :model="passwdForm" :rules="rules" ref="passwdForm" label-width="150px">
                <el-form-item label="请输入原密码：" prop="originPasswd">
                    <el-input v-model="passwdForm.originPasswd" type="password" minlength="6"></el-input>
                </el-form-item>
                <el-form-item label="请输入新密码：" prop="newPasswd">
                    <el-input v-model="passwdForm.newPasswd" type="password" minlength="6"></el-input>
                </el-form-item>
                <el-form-item label="请再次输入密码：" prop="checkPasswd">
                    <el-input v-model="passwdForm.checkPasswd" type="password"></el-input>
                </el-form-item>
            </el-form>
            <div slot="footer">
